...
import AnnouncementForm from './ParentannouncementForm';
import './parentAnnouncement.css';

function SelectParentAnnoucementRooms({ setCurrentScreen }) {
		...
		<>
					...
					<div className="flex justify-between items-center">
						...
						<span style={{ paddingTop: '3px' }}>
							<Typography variant="subtitle1" className="font-bold">
								{/* <h1 style={{fontSize:'20px'}}>Select Room</h1> */}
			...
			{displayParentannouncementForm && (
				<AnnouncementForm
					...
					room_all={selectedRooms.length === allRooms.length}
				/>
			)}
		</>
	);
...
export default SelectParentAnnoucementRooms;
