												...
												<div className="dose flex flex-col">
													{[1, 2, 3, 4, 5].map(i => (
														<div
															...
															className={`flex p-6 py-12 border-l ${
																i !== 5 ? 'border-b' : ''
															}`}
														>
															{i}
														...
														<div className="immu flex flex-col border-l">
															{!!im?.is_exempted && (
																<div
																	...
																	style={{ backgroundColor: '#FFF8C7', fontSize: 10 }}
																>
																	Exempted
																</div>
															)}
															...
															{!im?.is_exempted &&
																Array.from(
																	...
																	return (
																		<div
																			className={`dose flex flex-row justify-between p-6 py-12 ${
											...
											return (
												<div className="immu flex flex-col border-l">
													{!!im?.is_exempted && (
														<div
															// className="flex items-center justify-center flex-grow imunizationData"
															className="imunizationSchoolExempted"
