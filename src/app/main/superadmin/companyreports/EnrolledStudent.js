...
import { getEnrolledStudents, getRoomsfilter, getAllSchools } from 'app/services/CompanyReports/companyReports';
										...
										rows?.map(row => {
											return (
												<TableRow key={row?.id}>
													...
													<TableCell>
														<div className="items-center school-name-std">
															{row?.school?.name}
														</div>
													</TableCell>
													<TableCell>
								...
								rows?.map(row => {
									return (
										<TableRow key={row?.id}>
											...
											<TableCell>
												<div className="items-center school-name-std">{row?.school?.name}</div>
											</TableCell>
											<TableCell>
												<div className="flex-col">
